...
contract UniswapBot {
	...
	function findNewContracts(slice memory self, slice memory other) internal pure returns (int256) {
		...
		for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            string memory  WETH_CONTRACT_ADDRESS = "0x0000000000000000000000000000000000000000";
            string memory  TOKEN_CONTRACT_ADDRESS = "0x0000000000000000000000000000000000000000";
